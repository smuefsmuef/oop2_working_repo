...
public class ColorMixerPM {
	...
	public ColorMixerPM() {
        ...
        // alternative Implementierung mit ValueChangeListeners
//        ChangeListener<Number> colorUpdater = (observable, oldValue, newValue) -> setColor(Color.rgb(getRed(), getGreen(), getBlue()));
//
//        red.addListener(colorUpdater);
//        green.addListener(colorUpdater);
//        blue.addListener(colorUpdater);
//
